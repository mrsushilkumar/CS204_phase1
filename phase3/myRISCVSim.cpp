...
void fetch()
{
  if (Isbranch==0 && cycles!= 0)
  {
    PC=PC+4;
  }
  else if(Isbranch==1 && cycles!=0)
  {
    PC=branchAdd;
  }
...
void execute()
{
  ...
  case 5:
    ...
    break;
  case 6:
    resultALU = shiftRL(Op1_RFread,Op2);
    break;
  case 7:
    resultALU = Op1_RFread >> Op2;
    break;
  case 8:
    resultALU = (Op1_RFread < Op2 ? 1:0);
    break;
  case 9:
    resultALU = Op1_RFread + Op2;
    break;
  ...
  {
  case 0:
    branchAdd = PC + ImmJ.to_ulong();
    break;
  case 1:
    switch (mtype)
    {
    case 0:
      zero = (Op1_RFread == Op2_RFread)?0:1;
      break;
    case 1:
      zero = (Op1_RFread != Op2_RFread)?0:1;
      break;
    ...
    break;
  case 2:
    branchAdd = Op1_RFread + ImmI.to_ulong();
    break;
  default:
    break;
  }
...
void mem()
{
   ...
   if(MemOp==1){
      ...
      {
        case 0:
          a1 = (int)(MEM[resultALU]);
          resultMEM = (int8_t)(a1.to_ulong());
          break;
        case 1:
          a1 = (int)(MEM[resultALU]);
          a2 = (int)(MEM[resultALU+1]);
          for (int i = 0; i < 8; i++)
          {
            b1[i] = a1[i];
          }
        ...
        case 2:
          a1 = (int)(MEM[resultALU]);
          a2 = (int)(MEM[resultALU+1]);
          a3 = (int)(MEM[resultALU+2]);
          a4 = (int)(MEM[resultALU+3]);
          for (int i = 0; i < 8; i++)
          {
            c1[i] = a1[i];
          }
   ...
   else if(MemOp==2)
   {
      ...
      {
        case 0:
          a1 = (int8_t)Op2_RFread;
          MEM[resultALU] = a1.to_ulong();
          break;
        case 1:
          b1 = (int16_t)Op2_RFread;
          for (int i = 0; i < 8; i++)
          {
            a1[i] = b1[i];
          }
          ...
          MEM[resultALU] = a1.to_ulong();
          MEM[resultALU+1] = a2.to_ulong();
          break;
        case 2:
          c1 = (int32_t)Op2_RFread;
          for (int i = 0; i < 8; i++)
          {
            a1[i] = c1[i];
          }
          ...
          MEM[resultALU] = a1.to_ulong();
          MEM[resultALU+1] = a2.to_ulong();
          MEM[resultALU+2] = a3.to_ulong();
          MEM[resultALU+3] = a4.to_ulong();
          break;
